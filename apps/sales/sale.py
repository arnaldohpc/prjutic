...
class SalesFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.txtClient.Wrap(-1)
        fgSizer1.Add(self.txtClient, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.txtAdress.Wrap(-1)
        fgSizer1.Add(self.txtAdress, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        self.Adress = wx.TextCtrl(
            self,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.Adress.SetMaxLength(0)
        self.Adress.Enable(False)

        fgSizer1.Add(self.Adress, 0, wx.ALL, 5)

        fgSizer4 = wx.FlexGridSizer(0, 4, 0, 0)
        fgSizer4.SetFlexibleDirection(wx.BOTH)
        fgSizer4.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)

        self.txtPayment = wx.StaticText(
            self,
            wx.ID_ANY,
            u"Condición:",
            wx.DefaultPosition,
        ...
        self.txtPayment.Wrap(-1)
        fgSizer4.Add(self.txtPayment, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        paymentChoices = []
        self.payment = wx.Choice(
            self, wx.ID_ANY, wx.Point(-1, -1), wx.Size(75, 20), paymentChoices, 0
        )
        self.payment.SetSelection(0)
        fgSizer4.Add(self.payment, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        fgSizer5.Add(self.warehouse, 0, wx.ALL, 5)
        ...
        fgSizer5.Add(self.txtOffice, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        fgSizer5.Add(self.office, 0, wx.ALL, 5)
        ...
        fgSizer6.SetMinSize(wx.Size(-1, 40))

        fgSizer6.AddSpacer((235, 10), 1, wx.ALL, 5)
        ...
        fgSizer6.Add(self.txtTotal, 0, wx.ALIGN_CENTER_VERTICAL, 5)

        fgSizer6.AddSpacer((10, 10), 1, 0, 5)
        ...
        fgSizer6.Add(self.employee1, 0, wx.ALIGN_CENTER_VERTICAL, 5)

        fgSizer1.Add(fgSizer6, 1, wx.ALL, 5)
        ...
        self.btnPrint.SetDefault()
        self.btnPrint.Enable(False)

        fgSizer8.Add(self.btnPrint, 0, wx.ALL, 5)
