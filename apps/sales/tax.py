...
class TaxFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.txtValue = wx.StaticText(
            self, wx.ID_ANY, u"Valor", wx.DefaultPosition, wx.Size(80, 15), wx.ALIGN_LEFT
        )
        self.txtValue.Wrap(-1)
        fgSizer1.Add(self.txtValue, 0, wx.ALL, 5)

        self.value = wx.TextCtrl(
            self,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.value.SetMaxLength(0)
        self.value.Enable(False)

        fgSizer1.Add(self.value, 0, wx.ALL, 5)
