...
class SectionFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.txtDepartment = wx.StaticText(
            self,
            wx.ID_ANY,
            u"Depatamento:",
            wx.DefaultPosition,
        ...
        self.txtDepartment.Wrap(-1)
        fgSizer1.Add(self.txtDepartment, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        departmentChoices = []
        self.department = wx.ComboBox(
            self,
            wx.ID_ANY,
            u"Combo!",
            wx.DefaultPosition,
        ...
        self.department.Enable(False)

        fgSizer1.Add(self.department, 0, wx.ALL, 5)
