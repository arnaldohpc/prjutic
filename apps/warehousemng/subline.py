...
class SublineFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.txtLine = wx.StaticText(
            self, wx.ID_ANY, u"Grupo:", wx.DefaultPosition, wx.Size(80, 15), wx.ALIGN_LEFT
        )
        self.txtLine.Wrap(-1)
        fgSizer1.Add(self.txtLine, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
